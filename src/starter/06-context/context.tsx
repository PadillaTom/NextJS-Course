...
// If instead of a String we want an Object:
// 1) Specify an interface for ceateContext<CustomType | undefined>(undefined);
// 2) <ThemeProviderContext.Provider value={}> (Respecting the CustomType needs).
